...
import 'package:daily_routine_app/models/todo_model/todo_category.dart';
import 'package:daily_routine_app/models/todo_model/todo_importance.dart';
import 'package:daily_routine_app/models/todo_model/todo_status.dart';
...
class ToDoModel {
  ...
  String canAddThis() {
    if (title.isEmpty) return "To Do nomi kiritilmagan";
